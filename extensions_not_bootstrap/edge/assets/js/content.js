...
browser.runtime.onMessage.addListener(
	function(request, sender, sendResponse) {
		if( request.message === "bookmark_add" ) {
			...
			$(document.body).delegate('#Modal_Bookmark_b select[name=bookmark_position]', 'change', function(){
			...
			$('body').delegate('#Modal_Bookmark_b #category_name', 'change', function(){
			...
			$(document.body).delegate('#Modal_Bookmark_b select[name=linkPosition]', 'change', function(){
	        ...
	        $("#Modal_Bookmark_b form").append($category_select_label);
	        $("#Modal_Bookmark_b form").append($category_select);
	        $('body').delegate('#Modal_Bookmark_b select[name=category_name]', 'change', function(){
			...
			$(document.body).delegate('#Modal_Bookmark_b select[name=category_position]', 'change', function(){
